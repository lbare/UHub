...
const subBuildingExample : Building = {
    ...
    description: "The Student Union Building (SUB) is the social hub of campus, providing a variety of services and amenities for students, faculty, staff and visitors.",
    image: "https://uvss.ca/wp-content/uploads/2024/01/SUB_WEBSLIDER_SPRING2019.jpg",
    location: {
...
const bookStoreBuildingExample : Building = {
    ...
    description: "The University of Victoria Bookstore is a not-for-profit corporation that serves the campus community. We are owned and operated by the University of Victoria Students' Society.",
    image: "https://uvss.ca/wp-content/uploads/2024/01/BOOKSTORE_WEBSLIDER_SPRING2019.jpg",
    location: {
...
const buildingExamples : Building[] = [coveBuildingExample, subBuildingExample, bookStoreBuildingExample]
